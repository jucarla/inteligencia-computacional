    ...
    def generate_player(self):
        ...
        while True:
            ...
            if self.map[y][x] == 0 and [x, y] not in self.packages and [x, y] not in self.goals:
                return SmartBatteryPlayer([x, y], 1.0)
...
class Maze:
    ...
    def game_loop(self):
        ...
        if self.record:
            ...
            video_filename = f"{video_dir}/game_recording_v2_{timestamp}.gif"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Delivery Bot v2 (Greedy Best-First Search): Navegue no grid, colete pacotes e realize entregas."
    )
    parser.add_argument(
        "--seed",
        type=int,
